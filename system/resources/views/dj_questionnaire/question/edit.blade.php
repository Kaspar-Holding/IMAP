        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="white_shd full margin_bottom_30">
              ...
              @endphp
              <form class="container-fluid" action="{{route('update_dj_questionnaire_question')}}" method="POST" style="padding:30px; padding-bottom:40px;">
                @csrf
                <input type="hidden" name="id" value="{{ $question->id }}">
                <input type="hidden" name="dj_questionnaire_id" value="{{ $question->dj_questionnaire_id }}">
                <div>
                  <label class="form-label">Question</label>
                  <input type="text" name="dj_questionnaire_question" class="form-control" value="{{$question->dj_questionnaire_question}}" >
                </div>
                <br>
                <div class="clonedata">
                ...
                {{-- <div>
                  ...
                  <textarea class="form-control" name="dj_questionnaire_question_description" rows="4"> {{$question->dj_questionnaire_description}}</textarea>
                </div> --}}
                <br>
