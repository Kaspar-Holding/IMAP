...
<section id="gallery">
    <div class="container wow fadeInUp gallery_section event_section">
        <h1 class="event_heading">14 February</h1>
        <div class="event_time">
            <div><i class="fa fa-clock-o" aria-hidden="true"></i><span class="event_t" style="margin-left: 10px;">7pm-11pm</span></div>
        </div>
        <div class="row gallery_row_1">
            <div class="col-sm-3">
                <img class="event-img" src="{{ asset('ui/images/five.png')}}" />
            </div>

            <div class="col-sm-9">
                <div class="events">
                    <div class=""><h1>Nighty Thirsty</h1></div>
                    <div>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla vitae, enim auctor dui, metus aliquam urna, odio eget. Est sem morbi nunc cras eu, quis sed. Lobortis molestie orci, ut lectus tellus adipiscing
                            mauris. Ultrices v
                        </p>
                    </div>
                    <div class="event-b"><button>BOOK A VIP BOOTH</button></div>
                </div>
            </div>
        </div>
