@extends('layouts.app')
@section('pageTitle','Add New Question')
@section('content')
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="white_shd full margin_bottom_30">
              ...
              <form class="container-fluid" action="{{ route('create_dj_questionnaire_question') }}" method="POST" style="padding:30px; padding-botom:40px;">
                @csrf
                <input type="hidden" name="questionnaire_id" value="{{ $questionnaire->id }}">
                <div>
                  <label class="form-label">Question *</label>
                  <input type="text" name="questionnaire_question" class="form-control" required >
                </div>
                <br>
                <div class="clonedata">
                    <div class="row abcd">
                ...
                {{-- <div>
                  ...
                  <textarea class="form-control" name="questionnaire_question_description" rows="4"></textarea>
                </div> --}}
                <br>
