...
<header id="header">
  ...
  ============================-->
<section id="gallery">
    <div class="container wow fadeInUp gallery_section">
        <h1 class="gallery_heading">14-feb-2021</h1>
        <div class="row gallery_row_1">     
        <div class="col-sm-6">
            <img class="gallery_lg_image" src="{{ asset('ui/images/one.png')}}"/>
        </div>
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 lineup_section">
            <div class="row">
            <div class="col-sm-6 col-md-6 col-xs-6"><img class="gallery_sm_image" src="{{ asset('ui/images/two.png')}}"/></div>
            <div class="col-sm-6 col-md-6 col-xs-6"> <img class="gallery_sm_image my-img"  src="{{ asset('ui/images/three.png')}}"/></div>
            </div>
            <div class="row" style="margin-top:18px">
            <div class="col-sm-6 col-md-6 col-xs-6"> <img class="gallery_sm_image"  src="{{ asset('ui/images/four.png')}}"/></div>
            <div class="col-sm-6 col-md-6 col-xs-6"> <img  class="gallery_sm_image my-img" src="{{ asset('ui/images/five.png')}}"/></div>
            </div>
        </div>
        
        </div>
        <div class="row gallery_row_2">
            <div id="demo" class="carousel slide" data-bs-ride="carousel">
               ...
               <!-- <div class="carousel-indicators">
                ...
                <div class="row gal-row">
                    ...
                    <div class="col-sm-4"><img src="{{ asset('ui/images/review-1.png')}}" alt="Los Angeles" class="g_img"></div>
                    <div class="col-sm-4"><img src="{{ asset('ui/images/review-2.png')}}" alt="Los Angeles" class="g_img my-img"></div>
                    <div class="col-sm-4"><img src="{{ asset('ui/images/review-3.png')}}" alt="Los Angeles" class="g_img my-img"></div>
    ...
    <div class="container wow fadeInUp gallery_section" style="margin-top:30px;">
        <h1 class="gallery_heading">14-feb-2021</h1>
        <div class="row gallery_row_1">     
        <div class="col-sm-6">
            <img class="gallery_lg_image" src="{{ asset('ui/images/one.png')}}"/>
