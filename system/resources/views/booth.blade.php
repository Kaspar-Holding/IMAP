...
<section id="events">
    <div class="container wow fadeInUp">
      <h1 class="event_style" style="text-align:center;">Book a booth</h1>
      ...
      <div id="demo" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner event_section" style="margin-top:40px;">
          <div class="carousel-item active">
            <div class=" col-lg-6 col-md-12 col-sm-6 style-img"><img src="{{ asset('ui/images/slider-1.png')}}" alt="Los Angeles" class="d-block booth-img"></div>
            <div class=" col-lg-6 col-md-12 col-sm-6 booth"><h1>VIP BOOTH</h1>
          ...
          <div class="carousel-item">
            ...
            <div class="col-lg-6 col-md-12 col-sm-6 booth"><h1>VIP BOOTH</h1>
              <p>Lorem ipsum dolor sit amet, consectetur
               adipiscing elit. Iaculis est commodo nunc
                egestas vitae amet, sit.</p>
                <button>BOOK NOW</button>
            </div>
          </div>
          <div class="carousel-item">
      ...
      <div id="demo" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner event_section" style="margin-top:60px;">
          <div class="carousel-item active">
            <div class=" col-lg-6 col-md-12 col-sm-6 style-img"><img src="{{ asset('ui/images/slider-1.png')}}" alt="Los Angeles" class="d-block booth-img"></div>
            <div class=" col-lg-6 col-md-12 col-sm-6 booth"><h1>VIP BOOTH</h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Iaculis est commodo nunc egestas vitae amet, sit.</p>
