...
<body>
  ...
  <div class="hero-container ani">
      <div class="wow fadeIn">
        <div class="hero-logo">
          <img src="{{ asset('ui/images/logo.png')}}"/>
        </div>

        <h1>Drinks, Pizza and Music</h1>
        <div class="actions">
          State of the Art Sound and Lighting. SA's Top DJs.<br/>
          Traditiona Woodfire Pizzas. Outdoor Seating Area.<br/>
          Vip Booths, Cocktails and Draught Bear
        </div>
      </div>
    </div>
  <div class="container wow fadeInUp" style="margin-top:70px;">
      <h1 class="heading_style">Weekly Lineup</h1>
    <div class="row">
      <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 thirsty_night">
        <div class="inner-block">
          <h5>Nighty Thirsty</h5>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Iaculis est commodo nunc egestas vitae amet, sit.  </p>
          <a href="#"><p>Read more <span><img src="{{ asset('ui/images/arrow-left.png')}}"  alt=""></span></p></a>
          </div>  
        </div>
      <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 lineup_section">
        <div class="row line_row_1">
          <div class="col-sm-6 col-md-6 col-xs-6 d-block"><img src="{{ asset('ui/images/two.png')}}"/></div>
          <div class="col-sm-6 col-md-6 col-xs-6 d-block "> <img src="{{ asset('ui/images/three.png')}}"/></div>
        </div>
        <div class="row line_row_2">
          <div class="col-sm-6 col-md-6 col-xs-6"> <img src="{{ asset('ui/images/four.png')}}"/></div>
          <div class="col-sm-6 col-md-6 col-xs-6 d-block"> <img src="{{ asset('ui/images/five.png')}}"/></div>
        </div>
      </div>
    </div>
  </div>
    <div class="container wow fadeInUp" style="margin-top: 70px;">
      <h1  class="heading_style">Upcoming Events</h1>
      <div id="demo" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner nighty_section">
          <div class="carousel-item active">
            <div class=" col-lg-6 col-md-12 col-sm-6 style-img"><img src="{{ asset('ui/images/slider-1.png')}}" alt="Los Angeles" class="d-block"></div>
            <div class=" col-lg-6 col-md-12 col-sm-6 content"><h1>Nighty Thirsty</h1>
            <p>Lorem ipsum dolor sit amet, consectetur<br/> adipiscing elit. Iaculis est commodo nunc<br/> egestas vitae amet, sit.</p>
            <button>BOOK A VIP BOOTH</button>
          </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="col-lg-6 col-md-12 col-sm-6 content"><h1>Nighty Thirsty</h1>
              <p>Lorem ipsum dolor sit amet, consectetur<br/>
               adipiscing elit. Iaculis est commodo nunc<br/>
                egestas vitae amet, sit.<br/></p>
              <button>BOOK A VIP BOOTH</button>
            </div>
          </div>
          <div class="carousel-item">
        ...
        <button class="carousel-control-prev" type="button" data-bs-target="#demo" data-bs-slide="prev">
          <span class="carousel-control-prev-icon" style="margin-right: 132px;"></span>
        </button>
    ...
    <div class="container wow fadeInUp review_section">
      <h1 class="heading_style">Reviews</h1>
      <div id="demo" class="carousel slide" data-bs-ride="carousel">
       ...
       <!-- <div class="carousel-indicators">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="col-sm-4 col-xs-4"><img src="{{ asset('ui/images/review-1.png')}}" alt="Los Angeles" class="review_img"></div>
            <div class="col-sm-4 col-xs-4"><img src="{{ asset('ui/images/review-2.png')}}" alt="Los Angeles" class="review_img"></div>
            <div class="col-sm-4 col-xs-4"><img src="{{ asset('ui/images/review-3.png')}}" alt="Los Angeles" class="review_img"></div>
          </div>
          <div class="carousel-item">
            <div class="col-sm-4 col-xs-4"><img src="{{ asset('ui/images/review-1.png')}}" alt="Los Angeles" class="review_img"></div>
            <div class="col-sm-4 col-xs-4"><img src="{{ asset('ui/images/review-2.png')}}" alt="Los Angeles" class="review_img"></div>
    ...
    <div class="container wow fadeInUp" style="margin-top: 70px;">
      <h1 class="heading_style" style="padding-bottom:20px!important;">Contact Us</h1>
      <p class="para">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Iaculis est<br> commodo nunc egestas vitae amet, sit.  </p>
      <form action="" class="mt-5">
          <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                      <input type="text" class="form-control input_style" placeholder="Name">
                  </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group">
                      <input type="email" class="form-control input_style" placeholder="Email">
                  </div>
              </div>
          </div>
          <div class="mt-3 form-group">
              <textarea class="form-control input_style" placeholder="Message" rows="6"></textarea>
          </div>
      </form>
      <div class="text-center">
          <button class="btn bookvip-2">BOOK A VIP BOOTH</button>
      </div>
  </div>
  </section>
  <!--==========================
