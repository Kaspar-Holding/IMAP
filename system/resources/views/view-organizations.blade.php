...
<html data-wf-page="6447df7a194993334979465c" data-wf-site="643d23859a03d460b5afe396">
<head>
  <meta charset="utf-8">
  <title>View Organizations</title>
  <meta content="View Organizations" property="og:title">
  <meta content="View Organizations" property="twitter:title">
...
<body>
  ...
  <div class="organizations wf-section">
    <div class="container-2 w-container">
      <h3 class="heading-8">Organizations Created</h3>
      <div class="div-block-2">
        <div class="w-row">
          <div class="column-7 w-col w-col-1"><img src="images/job-user-img-6-100x100.png.png" loading="lazy" alt="" class="image-2"></div>
          <div class="column-12 w-col w-col-11">
            <div>
              <div class="w-row">
                ...
                <div class="column-8 w-col w-col-1"><img src="images/Vector-3.png" loading="lazy" alt="" class="edit"><img src="images/Ellipse-13.png" loading="lazy" alt="" class="image-3"></div>
              </div>
              <div class="detail">
