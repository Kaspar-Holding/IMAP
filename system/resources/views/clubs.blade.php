...
<section id="events">
    <div class="container wow fadeInUp">
      <h1  class="event_style" style="text-align:center;">club special</h1>
      <div id="demo" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner event_section">
          <div class="carousel-item active">
            <div class=" col-lg-6 col-md-12 col-sm-6 style-img"><img src="{{ asset('ui/images/event.png')}}" alt="" class="d-block event_img" style=""></div>
            <div class=" col-lg-6 col-md-12 col-sm-6 event"><h1>drinks special</h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Iaculis est commodo nunc egestas vitae amet, sit. Iaculis est commodo nunc egestas vitae amet, sit.</p>
