...
<head>
    ...
    <link rel='stylesheet prefetch' href='/yoco/demo/demo.css'>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"
          integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
</head>
<body>

@include('yoco.navbar', ['other' => 'popup'])
...
<!-- Pre setup -->
<script>
    var query = {!! json_encode($_GET['event_title']) !!};
    // alert(query);
    // Lets decide on some data
    var price = {!! json_encode($_GET['price']) !!};
    // the currency (must be ZAR)
    var currency = 'ZAR';
    // the name at the top of the popup (either shop or product)
    var product_title = {!! json_encode($_GET['event_title']) !!};
    ...
    // Customer Name
    var customer_name = {!! json_encode($_GET['customer_name']) !!};
    // Customer Email
    var customer_email = {!! json_encode($_GET['customer_email']) !!};
    // Metadata (optional)
    var bill_note = "INV" + {!! json_encode($_GET['booking_id']) !!};
    ...
    $('.shop-yococard .bill_note').text(bill_note);
        ...
        $.ajax(
            {
                ...
                'success': function (data) {
                    ...
                    log_activity("ID " + data.id + " " + data.id);
                    formSubmitted = true;
                    ...
                    swal({
                        ...
                        text: "Your event is booked successfully!",
                        icon: "success",
                        button: "Back",
                    }).then(function () {
                        // location.reload();
